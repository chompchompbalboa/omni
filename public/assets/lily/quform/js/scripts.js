...
(function ($) {
	$(window).load(function () {
		// Preload images
		var images = [
      		'/assets/lily/quform/images/close.png',
    		'/assets/lily/quform/images/success.png',
    		'/assets/lily/quform/images/error.png',
    		'/assets/lily/quform/images/default-loading.gif'
    	];
