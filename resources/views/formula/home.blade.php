...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/assets/formula/css/main.css" />
    ...
    <body>
        ...
        <!-- Page Wrapper -->
            <div id="page-wrapper">
                ...
                -->
                    <section id="banner" data-video="/assets/formula/video/banner">
                        <div class="inner">
                            <header>
                        ...
                        <!-- One -->
                            <section id="one" class="main">
                                <div class="inner spotlight style1">
                                    ...
                                    -->
                                    <span class="image"><img src="/assets/formula/images/pic01.svg" alt="" /></span>
                                </div>
                            </section>
                            ...
                            <section id="two" class="main">
                                <div class="inner spotlight alt style2">
                                    ...
                                    <!--
                                        ...
                                        320x340 or at least the same aspect ratio (16:17).
                                    -->
                                    <span class="image"><img src="/assets/formula/images/pic02.svg" alt="" /></span>
                                </div>
                            </section>
                            ...
                            <section id="three" class="main">
                                <div class="inner spotlight style3">
                                    ...
                                    <!--
                                        ...
                                        320x340 or at least the same aspect ratio (16:17).
                                    -->
                                    <span class="image"><img src="/assets/formula/images/pic03.svg" alt="" /></span>
                                </div>
                            </section>
        ...
        <!-- Scripts -->
            <script src="/assets/formula/js/jquery.min.js"></script>
            <script src="/assets/formula/js/jquery.scrolly.min.js"></script>
            <script src="/assets/formula/js/jquery.scrollex.min.js"></script>
            <script src="/assets/formula/js/skel.min.js"></script>
            <script src="/assets/formula/js/util.js"></script>
            <!--[if lte IE 8]><script src="/assets/formula/js/ie/respond.min.js"></script><![endif]-->
            <script src="/assets/formula/js/main.js"></script>
