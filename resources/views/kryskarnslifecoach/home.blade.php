...
<html>
    <head>
        ...
        <!--[if lte IE 8]><script src="{{ $assetsPath }}/js/ie/html5shiv.js"></script><![endif]-->
        <link rel="stylesheet" href="{{ $assetsPath }}/css/main.css" />
        <noscript><link rel="stylesheet" href="{{ $assetsPath }}/css/noscript.css" /></noscript>
        <!--[if lte IE 9]><link rel="stylesheet" href="{{ $assetsPath }}/css/ie9.css" /><![endif]-->
    ...
    <body class="is-loading-0 is-loading-1">
            ...
            <div id="wrapper">
                ...
                <!-- Home -->
                    <article id="home" class="panel special">
                        <div class="image editable-gallery" id="untitled-region-13">
                            <img src="{{ $assetsPath }}/images/Krys_C.2_WS.jpg" alt="" style="display: none;">
                        </div>
                        <div class="content">
                            <div class="inner">
                    ...
                    <article id="about" class="panel secondary">
                        ...
                        <div class="content">
                            ...
                            <div class="inner">
                                ...
                                <p class="editable" id="untitled-region-10">Originally from Los Angeles, I have extensive work history in the film industry, as well as corporate marketing and non-profit program coordination. I now live in Seattle with my partner and two kitties. When I am not busy cultivating leaders, I spend my time chasing sun spots around my apartment building.</p>
                ...
                <!-- Contact -->
                    <article id="contact" class="panel secondary">
                        ...
                        <div class="content">
                            <div class="inner">
                                <form id="formspree" method="post" action="https://formspree.io/krys@kryskarnslifecoach.com">
                                    ...
                                    <input type="hidden" name="_cc" value="krys@kryskarnslifecoach.com" />
                                    <ul class="actions">
                                        <li><input id="formspree_submit" type="submit" value="Send" class="special" /></li><span id="formspree_success"></span>
                                    </ul>
                                </form>
                            </div>
                        </div>
        ...
        <!-- Scripts -->
            ...
            <script src="{{ $assetsPath }}/js/formspree.js"></script>
    </body>
</html>