...
<head>
    ...
    <!-- Stylesheets
    ============================================= -->
    <link href="http://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700|Roboto:300,400,700|Kristi" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="/assets/{{ $path }}/css/main.css" />
    <link rel="stylesheet" href="/assets/{{ $path }}/css/bootstrap.css" type="text/css" />
    <link rel="stylesheet" href="/assets/{{ $path }}/style.css" type="text/css" />

    <!-- One Page Module Specific Stylesheet -->
    <link rel="stylesheet" href="/assets/{{ $path }}/css/onepage.css" type="text/css" />
    <!-- / -->

    <link rel="stylesheet" href="/assets/{{ $path }}/css/dark.css" type="text/css" />
    <link rel="stylesheet" href="/assets/{{ $path }}/css/font-icons.css" type="text/css" />
    <link rel="stylesheet" href="/assets/{{ $path }}/css/et-line.css" type="text/css" />
    <link rel="stylesheet" href="/assets/{{ $path }}/css/animate.css" type="text/css" />
    <link rel="stylesheet" href="/assets/{{ $path }}/css/magnific-popup.css" type="text/css" />

    <link rel="stylesheet" href="/assets/{{ $path }}/css/fonts.css" type="text/css" />

    <link rel="stylesheet" href="/assets/{{ $path }}/css/responsive.css" type="text/css" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />


    <!-- Document Title
    ============================================= -->
    <title>Machinists Inc</title>
    ...
    <div id="wrapper" class="clearfix">
        ...
        <section id="slider" class="slider-parallax full-screen">
            ...
            <div class="slider-parallax-inner">
                ...
                <div class="col-md-5 col-sm-6 full-screen dark" style="background-color: #383838;">
                    <div class="vertical-middle subscribe-widget" data-loader="button">
                        <div class="col-padding">
                            ...
                            <form id="slider-subscribe-form" action="../include/subscribe.php" method="post" class="nobottommargin">
                                <div class="col_half">
                                ...
                                <button type="submit" class="button button-light button-circle button-border noleftmargin topmargin-sm" value="submit">Subscribe Me</button>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-md-7 col-sm-6 full-screen center nopadding" style="background: url('images/page/main.jpg') center center no-repeat; background-size: cover;">
                    <div class="vertical-middle dark center clearfix" style="z-index: 2;">
                        ...
                        <div class="emphasis-title nobottommargin">
                            <h1>
                                <span class="t-rotate t400 opm-large-word nocolor" style="font-family: 'Kristi', cursive;">different.</span>
                            </h1>
                        </div>

                    </div>
                    <div class="fslider" data-speed="2000" data-pause="4000" data-animation="fade" data-arrows="false" data-pagi="false" style="position: absolute; width: 100%; height: 100%; top: 0; left: 0; background-color: #333;z-index:1;">
