...
<html>
	<head>
		<title>Northwest Aire Services</title>
		<meta charset="utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<!--[if lte IE 8]><script src="assets/js/ie/html5shiv.js"></script><![endif]-->
		<link rel="stylesheet" href="/assets/{{ $path }}/css/main.css" />
		<!--[if lte IE 9]><link rel="stylesheet" href="/assets/{{ $path }}/css/ie9.css" /><![endif]-->
		<!--[if lte IE 8]><link rel="stylesheet" href="/assets/{{ $path }}/css/ie8.css" /><![endif]-->
	</head>
	<body>
